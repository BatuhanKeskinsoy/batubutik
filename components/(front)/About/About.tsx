    ...
    <div className="container mx-auto px-4 flex lg:flex-row flex-col gap-8">
      <div className="flex flex-col lg:gap-6 gap-4 lg:w-3/5 w-full text-xl tracking-wide">
        ...
        <p>
          ...
          memnuniyetini en ön planda tutmakla birlikte her sezon modayı yakından takip ederek, en yeni
          trendleri ve en rahat tasarımları müşterilerimizle buluşturuyoruz.
        </p>
        <p>
          Müşterilerimize sadece ürün satışı değil, aynı zamanda tarz ve konfor da sunmayı amaçlıyoruz.
        </p>
        <p>
          ...
          sitemiz ile Türkiye'nin dört bir yanındaki
