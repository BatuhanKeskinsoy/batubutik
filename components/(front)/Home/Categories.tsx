      ...
      <div className="flex lg:flex-row flex-col gap-4 lg:gap-8 items-center justify-center w-full h-full text-white">
        {categories.map((category, key) => (
          <Link
            ...
            title={category.name}
            key={key}
            className="bg-gray-100 dark:bg-zinc-800 hover:bg-site hover:dark:bg-site dark:hover:border-site hover:border-transparent relative flex lg:items-end items-center justify-start w-full h-full overflow-hidden cursor-pointer lg:rounded-2xl lg:shadow-xl hover:lg:shadow-site/20 hover:lg:scale-105 transition-all duration-300 group"
          >
            <FaCircleArrowRight className="lg:size-16 size-12 absolute right-0 lg:top-6 z-10 text-gray-700 dark:text-gray-200 group-hover:text-white scale-[2] group-hover:scale-[1] lg:translate-x-12 translate-x-10 lg:translate-y-16 translate-y-10 group-hover:-translate-x-6 group-hover:-translate-y-0 transition-all duration-300" />
