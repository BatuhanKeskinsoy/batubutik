      ...
      <div className="flex lg:flex-row flex-col gap-4 lg:gap-8 items-center justify-center w-full h-full text-white">
        {categories.map((category, key) => (
          ...
          >
            ...
            <div className="text-gray-800 dark:text-gray-200 flex lg:p-8 p-4 lg:text-4xl text-2xl z-10 transition-all duration-300 group-hover:text-white select-none">
              {category.name}
            </div>
          </Link>
        ))}
