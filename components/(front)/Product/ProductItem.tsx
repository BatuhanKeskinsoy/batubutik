    ...
    <>
      {showProductArea && (
        <div className="fixed w-screen h-screen top-0 left-0 flex items-center justify-center z-10">
          ...
          ></div>
          <div
            className={`relative bg-white rounded-sm 2xl:w-[calc(100vw-34%)] xl:w-[calc(100vw-250px)] lg:w-[calc(100vw-250px)] lg:h-[calc(100vh-18%)] w-screen h-screen shadow-lg shadow-gray-600 transition-all duration-300 animate-modalContentSmooth z-20`}
          >
            <CustomButton
        ...
        <div className="flex flex-col w-full">
          ...
          >
            ...
            {product.stock > 0 && (
              ...
              >
                <CustomButton
                  title={!loadingAddToBasket ? "Sepete Ekle" : "Ekleniyor.."}
