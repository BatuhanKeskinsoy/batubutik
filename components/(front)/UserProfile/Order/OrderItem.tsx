  ...
  return (
    <div className="relative w-full pl-6 py-4 first:pt-0 last:pb-0">
      ...
      <div className="relative flex justify-between mb-2 dark:bg-green-900 bg-green-500 rounded-lg">
        ...
        <div className="flex w-full items-center justify-between lg:px-4 px-2 text-sm text-white py-2">
      ...
      <div className="bg-gray-100 dark:bg-zinc-800 p-4 pt-6 flex flex-col gap-4 rounded-lg">
        ...
        <div className="flex max-lg:flex-col justify-between items-center gap-4">
          <div className="flex lg:flex-col justify-between lg:items-start items-center gap-1 max-lg:w-full">
            <span className="dark:text-gray-400 text-gray-500 text-base">
              Sipariş Tutarı
            </span>
          ...
          <div className="flex max-lg:flex-col gap-3 items-center max-lg:w-full">
            <Link
              ...
              className="flex justify-between items-center gap-2 dark:bg-zinc-900 max-lg:w-full bg-white shadow-md py-2 px-4 rounded-md text-base hover:bg-site dark:hover:bg-site hover:text-white transition-all duration-300"
            >
            ...
            <CustomButton
              title="İade Et"
              containerStyles="flex justify-between items-center gap-2 dark:bg-zinc-900 max-lg:w-full bg-white shadow-md py-2 px-4 rounded-md text-base hover:bg-site dark:hover:bg-site hover:text-white transition-all duration-300"
